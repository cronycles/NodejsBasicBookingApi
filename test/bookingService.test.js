...
//       it('responds always with error 1 and "Invalid request" text message', (done) => {
//         request(app)
//           .post('/bookings')
//           .send(body)
...
//   ];
//   VALID_REQUEST_BODY.forEach((body) => {
//     describe('POST /bookings with all input sended', () => {
//       it('calls a BookingService.createBooking', (done) => {
//         var spy = chai.spy;
//         var createBookingSpy = spy.on(BookingService, 'createBooking');
//         request(app)
//           .post('/bookings')
//           .send(body)
//           .set('Accept', 'application/json')
//           .end((err, res) => {
//             expect('Content-Type', /json/)
//             expect(createBookingSpy).to.have.been.called();
//             done();
//           });
//       });
//     });
...
//       it('responds error with id 2 and "Invalid client id "text message', (done) => {
//         request(app)
//           .post('/bookings')
